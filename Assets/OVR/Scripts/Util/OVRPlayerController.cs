...
public class OVRPlayerController : MonoBehaviour
{
	...
	void Start()
	{
		...
		sb.Append ("Time,X-angle, Y-angle,Z-angle\n");
	...
	IEnumerator LogData()
	{
		while (true) 
		{
			Quaternion eyeRotation = CameraController.centerEyeAnchor.rotation;
			sb.Append (""+System.DateTime.Now+","+eyeRotation.eulerAngles.x+","+eyeRotation.eulerAngles.y+","+eyeRotation.eulerAngles.z+"\n");
	...
	{
		System.IO.File.AppendAllText ("Orientation-Data-" + System.DateTime.Now.Ticks.ToString () + ".csv",sb.ToString());
	}
}
